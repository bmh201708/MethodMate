...
export default async function handler(request) {
  ...
  try {
    ...
    const searchResponse = await fetch(`${SEMANTIC_API_BASE}/paper/search?query=${encodeURIComponent(searchQuery)}&limit=5&fields=title,abstract,url,openAccessPdf,year,citationCount,authors`, {
      headers: {
