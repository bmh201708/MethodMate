...
|---|---|---|
| 简明陈述本研究中"研究假设"的具体内容或核心假设点 | 明确标注参考文献中相关内容所在的位置（如页码、小节标题），并摘录能够体现其核心思想的原文语句（可选取关键词句或关键表达） | 简要说明本研究假设如何受到该文献的启发，具体体现在哪些方面（如理论依据、变量设置、比较逻辑、预期方向等），强调借鉴的思路、结构或推理路径 |
...
| 当前方案中的做法 | 参考文献对应内容 | 借鉴关系说明 |
|---|---|---|
| 简要说明本研究在实验设计中的具体做法，例如分组方式、变量设置、任务类型或操作流程等 | 明确标注参考文献中相关内容所在的位置（如页码、小节标题），并摘录能够体现其核心思想的原文语句（可选取关键词句或关键表达） | 简要说明当前实验设计在何种程度上受到该文献的启发，具体体现在何种设计思路、变量操作、对照逻辑或流程结构等方面 |
...
${baseInfo}`
      ...
      case 'results':
        prompt = `
**请根据当前研究方案中的"结果呈现"部分内容，结合所引用的一篇或多篇参考文献，分析并指出本方案在结果呈现方式上的具体做法在哪些方面受到已有文献的启发或借鉴。**

请生成一个表格，最多包含5行，每行分析一个借鉴关系。表格应严格按照以下格式：

| 当前方案中的做法 | 参考文献对应内容 | 借鉴关系说明 |
|---|---|---|
| 简要说明本研究对结果呈现的设计，例如预期结果或结论、以及所拟采用的图表类型 | 明确标注参考文献中相关内容所在的位置（如页码、小节标题），并摘录能够体现其核心思想的原文语句（可选取关键词句或关键表达） | 简要说明当前方案在结果呈现方面如何受到该文献的启发，具体体现在哪些方面（如预期差异的表达方式、图表设计风格、指标对比结构或结论推理框架等） |
...
请生成一个表格格式的来源介绍，表格应包含以下列：

| 参考文献 | 核心贡献 | 具体引用内容 | 对当前研究的启发 |
|---|---|---|---|
| 文献标题 | 该文献对当前研究部分的核心贡献 | 文献中的具体内容和原文引用 | 如何启发了当前研究的设计 |
