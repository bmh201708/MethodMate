...
请严格按照下面的结构和要求，生成一份约300-500字的来源介绍。

**### 输出结构：**

**总体概述:**
（用一句话简要说明当前研究部分是在哪些文献的启发下形成的。）

**各参考文献具体分析:**
（请在这里逐一分析每篇参考文献）

#### 参考文献 1: [此处填入参考文献1的标题]
   - **核心贡献:** [在此处用1-2句话总结该文献对当前研究部分的**核心贡献**，例如，它提供了理论框架、关键的研究方法、具体的实验设计思路或数据分析技术。]
   - **原文引用支持:** [在此处提供1-2个直接、精炼的**原文引述**来支撑你的总结。引述应使用“...”格式，并确保与核心贡献高度相关。]

(继续分析所有提供的参考文献...)

**综合应用说明:**
（在此处用2-3句话总结你是如何**整合**上述所有文献的思路，形成了当前研究方案中“${sectionName}”部分的最终设计。如果提供了用户需求，请在此处说明整合时是如何考虑这些需求的。）

**### 关键要求：**
- **逐一分析:** 必须对每篇参考文献进行独立的分析，不能将它们混为一谈。
- **先总结后引用:** 严格遵循“核心贡献”在前，“原文引用支持”在后的结构，让逻辑更清晰。
- **引文精准:** 引用内容必须是与“${sectionName}”最相关的原文片段，避免无关信息。
- **考虑用户需求:** 如果提供了用户需求，请在“综合应用说明”中体现。
- **保持客观:** 以中立、客观的学术口吻进行分析。
`
